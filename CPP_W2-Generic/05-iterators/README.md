The program [iterators.cpp](iterators.cpp) copies values from one vector to
...
```shell
check50 -l --ansi-log ppetoumenos/comp26020-problems/2023-2024/CPP_W2-Generic/06-iterators
```
