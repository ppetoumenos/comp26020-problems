The program [rangefor.cpp](rangefor.cpp) is the same as the iterators one, but
...
```shell
check50 -l --ansi-log ppetoumenos/comp26020-problems/2024-2025/CPP_W2-Generic/06-rangefor
```
